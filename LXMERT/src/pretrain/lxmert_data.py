...
class InputExample(object):
    ...
    def __init__(self, uid, sent, replace_sent, visual_feats=None,
                 obj_labels=None, attr_labels=None,
                 is_matched=None, ans_matched=None, label=None, replace_label=None,
                 answer=None, replace_answer=None):
        self.uid = uid
        self.sent = sent
        self.replace_sent = replace_sent  # update on 0915,
        self.visual_feats = visual_feats
        self.obj_labels = obj_labels
        self.attr_labels = attr_labels
        self.is_matched = is_matched  # whether the visual and obj matched
        self.ans_matched = ans_matched
        self.label = label
        self.replace_label = replace_label
        self.answer = answer
        self.replace_answer = replace_answer
...
class LXMERTTorchDataset(Dataset):
    def __init__(self, dataset: LXMERTDataset, topk=-1):
        ...
        self.task_va = args.task_va
        self.task_va2 = args.task_va2
    ...
    def __getitem__(self, item: int):
        ...
        example = InputExample(
            uid, sent, replace_sent, (feats, boxes),
            (obj_labels, obj_confs), (attr_labels, attr_confs),
            is_matched, ans_matched, label, replace_label, answer, replace_answer
        )
        return example
